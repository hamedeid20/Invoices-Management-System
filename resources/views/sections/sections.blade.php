...
<div class="row">
	<div class="col-xl-12">
						...
						<tbody>
							...
							@foreach ($sections as $section)
								...
								<tr>
									...
									<td>
										@can('تعديل قسم')
										<a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-id="{{ $section->id }}" data-section_name="{{ $section->section_name }}" data-description="{{ $section->description }}" data-toggle="modal" href="#section_update" title="تعديل"><i class="las la-pen"></i></a>
										@endcan
										@can('حذف قسم')
										<a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-id="{{ $section->id }}" data-section_name="{{ $section->section_name }}" data-toggle="modal" href="#section_delete" title="حذف"><i class="las la-trash"></i></a>
										@endcan
									</td>
								</tr>
							@endforeach
		...
		<div class="modal" id="section_delete">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
...
<script>
    $('#section_update').on('show.bs.modal', function(event) {
...
<script>
    $('#section_delete').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var section_name = button.data('section_name')
        var modal = $(this)
